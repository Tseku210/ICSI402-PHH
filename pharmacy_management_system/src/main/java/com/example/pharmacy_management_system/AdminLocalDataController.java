...
public class AdminLocalDataController {
    ...
    ObservableList<User> localDB = FXCollections.observableArrayList(
            new User(1, "hello", "bue", "python", "someth", "gay", "stupid", role),
            new User(2, "dorj", "bold", "java", "ruby", "straight", "213", role));
