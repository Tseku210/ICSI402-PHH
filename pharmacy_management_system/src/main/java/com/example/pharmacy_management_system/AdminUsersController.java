...
public class AdminUsersController {
    ...
    ObservableList<User> userList = FXCollections.observableArrayList(new User(0, "123", "bold", "suren", "somewhere", "something", "123", role));
    ...
    void onAddUser(ActionEvent event) {
        ...
        User newUser = new User(idCount++, user_staffId.getText(), user_firstname.getText(), user_lastname.getText(),
                user_username.getText(), user_address.getText(), user_phone.getText(), role);
...

                    {
                        updateButton.setOnAction((ActionEvent event) -> {
                            ...
                            result.ifPresent(updatedUser -> {
                                // TODO: update the user in the database or wherever the user data is stored
                                users_table.refresh();
                            });
                        });
                    }
