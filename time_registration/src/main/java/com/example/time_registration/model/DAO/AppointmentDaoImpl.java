...
public class AppointmentDaoImpl implements AppointmentDao{
    ...
    private AppointmentDaoImpl() {
        try {
            this.connection = DriverManager.getConnection("jdbc:mysql://localhost:3306/clinic", "root", "");
    ...
    public boolean addAppointment(Appointment appointment){
        ...
        try {
            ...
            java.sql.Timestamp sqlTimestamp = java.sql.Timestamp.valueOf(appointment.getTime());
