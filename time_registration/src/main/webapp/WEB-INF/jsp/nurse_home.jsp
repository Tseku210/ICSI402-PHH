...
<script>
    function cancelAppointment(appointmentId) {
        ...
        xhr.open('POST', '/nurse/cancel', true);
        xhr.setRequestHeader('Content-Type', 'application/x-www-form-urlencoded');
        xhr.onreadystatechange = function () {
            if (xhr.readyState === XMLHttpRequest.DONE) {
                if (xhr.status === 200) {
                    window.location.href = '/nurse_home';
                } else {
    ...
    function deleteAppointment(appointmentId) {
        let xhr = new XMLHttpRequest();
        xhr.open('POST', '/nurse/delete', true);
        xhr.setRequestHeader('Content-Type', 'application/x-www-form-urlencoded');
        xhr.onreadystatechange = function () {
            if (xhr.readyState === XMLHttpRequest.DONE) {
                if (xhr.status === 200) {
...
<body>
<%--<h1>Цаг захиалгын түүх</h1>--%>
<%--<header class="header">--%>
<%--  <div>--%>
<%--    <img class="logo" src="https://dep.num.edu.mn/econ/wp-content/themes/numdepart/images/logo.png">--%>
<%--    <div>МУИС эмнэлгийн веб хуудас</div>--%>
<%--  </div>--%>
<%--  <ul class="main-nav">--%>
...
<a href="/nurse/logout" id="logout">Logout</a>
<div class="tabs">
