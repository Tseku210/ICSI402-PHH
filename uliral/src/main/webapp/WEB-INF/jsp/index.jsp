...
<div class="tabs">
    ...
    <ul>
        ...
        <button onclick="openModal()" class="btn-add">Оюутан нэмэх</button>
    </ul>
        ...
        <section>
            <table class="table">
                ...
                <tr>
                    ...
                    <td>
                        <h6 class="mb-0"><%= student.getFirstName() %></h6>
                        <small><%= student.getLastName() %></small>
                    </td>
                    <td>
                        <span class="status-wait"><%= student.getEmail() %></span>
                    </td>
                    <td>
                        <h6 class="mb-0">
                            <%= student.getPhoneNo() %>
                    ...
                    <td>
                        <button class="btn-cancel" onclick="deleteStudent('<%= student.getStudent_id() %>')">Устгах</button>
                    </td>
                </tr>
                <%
                        }
