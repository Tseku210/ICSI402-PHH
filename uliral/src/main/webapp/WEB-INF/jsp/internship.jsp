...
<%@ page import="com.example.uliral.model.entities.Diplom" %>
<%@ page import="com.example.uliral.model.entities.Internship" %><%--<%@ taglib prefix="c" uri="http://java.sun.com/jsp/jstl/core" %>--%>
...
<script>
    ...
    function deleteStudent(studentId) {
        ...
        xhr.open('POST', '/internship/delete', true);
        ...
        xhr.send('internshipId=' + encodeURIComponent(studentId));
    }
</script>
<body>
<h1>Тавтай морил</h1>
<div class="tabs">
    ...
    <ul>
        ...
        <button onclick="openModal()" class="btn-add">Дадлага нэмэх</button>
    </ul>
    <%--    <div class="slider"><div class="indicator"></div></div>--%>
    <form method="GET" action="/internship" class="filter-form">
        ...
        <section>
            <table class="table">
                ...
                <tr>
                    ...
                    <td>
                        <h6 class="mb-0"><%= internship.getStudent().getStudent_id() %></h6>
<%--                        <small><%= internship.get() %></small>--%>
                    </td>
                    <td>
                        <span class="status-wait"><%= internship.getCompanyName() %></span>
                    </td>
                    <td>
                        <h6 class="mb-0">
                    ...
                    <td>
                        <button class="btn-cancel" onclick="deleteStudent('<%= internship.getId() %>')">Устгах</button>
                    </td>
                </tr>
                <%
                        }
...
<div id="kk" class="modal">
    <div class="modalContent">
        ...
        <h2>Оюутан нэмэх</h2>
        <form action="/internship/add" method="post">
            <div>
